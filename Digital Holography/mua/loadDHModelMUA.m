...
% Load accuracies
MODEL_MATRIX = [dataPath '/' exp_id '/processed/DH/models/performances' num2str(dh_session) '_' model_label '.mat'];
...
% save
save([tmpPath, '/' 'dh' num2str(dh_session) '_models.mat'], 'dh_models');
movefile([tmpPath, '/' 'dh' num2str(dh_session) '_models.mat'], [dataPath '/' exp_id '/processed/DH/models/']);
