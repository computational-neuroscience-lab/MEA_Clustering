function plotDHWeights_keras(i_cell)

load(strcat(stimPath, "/DHSpots/spots_coords.mat"), "spots_coords_image");
load("keras_LNPb2_params.mat", "ws", "a", "b");
...
title_1 = strcat("KERAS #", string(i_cell), "   LNP accuracy = ",  string(dh_stats.accuracies(i_cell)));
