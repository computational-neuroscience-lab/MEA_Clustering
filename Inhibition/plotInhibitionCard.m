...
% rasters
plotDHRaster(cell_id, 'DMD_smallbin', 'single', ...
                    'Is_Subfigure', true, ...
                    'Columns_Indices', [1,3], ...
                    'Dead_Times', false, ...
                    'N_Columns', 8, ...
...
plotDHRaster(cell_id, 'DH_DMD_smallbin', 'single', ...
                    'Is_Subfigure', true, ...
                    'Columns_Indices', [2,4], ...
                    'Dead_Times', false, ...
                    'N_Columns', 8, ...
...
plotInhibitionWeights(cell_id, 'DMD_smallbin', 'DH_DMD_smallbin', ...
                'Is_Subfigure', true, ...
                'Labels', true);
...
fig_name = ['Inhibition_cell#' num2str(cell_id)];
