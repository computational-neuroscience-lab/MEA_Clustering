...
%% %%%%%%%%% Parameters %%%%%?? '
 ...
 %%%%% Channels to analyse %%%%%
%BEWARE
 Channels = 1:666; %number of cells
...
triggers_file = '/home/fran_tr/MEA_CLUSTERING/Experiments/180705/Sorted/Frames.mat'; %portable
...
IS.StimFilePath = 'binarysource1000Mbits_Giulia'; 
...
spikes_file = '/home/fran_tr/MEA_CLUSTERING/Experiments/180705/Sorted/SpikeTimes.data';
...
% For Jared :
% obj.length_constant_part = 5; 
% obj.length_variable_part = 20;
