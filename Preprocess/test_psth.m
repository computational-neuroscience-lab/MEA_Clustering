function test_psth(SpikeTimes, rep_begin_time_20khz, rep_end_time_20khz, meaRate, tBin, Stim, StimRate)
...
[PSTH, XPSTH, ~] = doPSTH(SpikeTimes, rep_begin_time_20khz, binSize, nTBins, meaRate, 1:numel(SpikeTimes));
