function setDataset(dataset_name, experiments, accepted_labels, mea_rate, psth_tBin)
...
for i_exp = 1:numel(experiments)
    ...
    repetitions_mat = [dataPath() '/' exp_id, '/processed/Euler/Euler_RepetitionTimes.mat'];
    stim_mat = [dataPath() '/' exp_id, '/processed/Euler/Euler_Stim.mat'];
...
%     [psth_chunk, euler_chunk] = extractEulerChunks(psth_chunk, 1/params.psth.tBin, euler, euler_sampler_rate);
    ...
    bad_tags = numel(SpikeTimes) - numel(indices_tags);
